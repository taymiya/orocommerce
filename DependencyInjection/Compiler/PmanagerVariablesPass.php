...
class PmanagerVariablesPass implements CompilerPassInterface
{
    const SERVICE_KEY = 'ibnab_pmanager.pdftemplate.variable_provider';
    const TAG         = 'ibnab_pmanager.pdftemplate.variable_provider';
