...
/**
 * @RouteResource("producttemplate")
 * @NamePrefix("ptoro_api_")
 */
class ProductTemplateController extends RestController
{
    /**
     * REST DELETE
     *
    ...
    {
        return $this->get('ibnab_pmanager.producttemplate.api');
    }
