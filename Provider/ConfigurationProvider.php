...
class ConfigurationProvider
{
    ...
    const DefaultRFQTemplate_FIELD = 'ibnab_pmanager.defaultrfqtemplate';
     ...
     * @return string
     */
    public function getDefaultRFQTemplate()
    {
        return $this->configManager->get(self::DefaultRFQTemplate_FIELD);
    }
    /**
     * @return string
     */
